...
adata = anndata.read_h5ad(r'C:\Users\ipmc\Documents\Package_Metrics\scanpy\scanpy\datasets\HCA_Barbry_Hg19_seurat.h5ad')
...
hist_internal(adata=adata,partition_keys=['leiden', 'louvain'],reference=['CellType'])
...
## Create test set
brain = anndata.read_h5ad(r'C:\Users\ipmc\Documents\Package_Metrics\scanpy\scanpy\datasets\brain.h5ad')
sc.pl.highest_expr_genes(brain, n_top=20, )
...
brain.write_h5ad(r'C:\Users\ipmc\Documents\Package_Metrics\scanpy\scanpy\datasets\test_dataset.h5ad')

## Load test set

test_set = anndata.read_h5ad(r'C:\Users\ipmc\Documents\Package_Metrics\scanpy\scanpy\datasets\test_dataset.h5ad')

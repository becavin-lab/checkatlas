...
def specificity_summary(adata, marker_genes, partition_key: str = 'CellType'):
    ...
    summary = pd.DataFrame(columns=['gene',
                          'expected celltype',
...
# TODO
def specificity_quality_control(adata: anndata,
    ...
    celltypes_checks = list(get_average_celltype_counts(adata,partition_key=partition_key).index)

...
![Static Badge](https://img.shields.io/badge/Spatial_decomposition-grey)
...
![$R^2$ illustration](../../images/metrics/r2.png)
> « Since the regression line does not miss any of the points by very much, the R2 of the regression is relatively high. » [Wikipedia](https://en.wikipedia.org/wiki/Coefficient_of_determination)
>
> © [Wikimedia](https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Okuns_law_quarterly_differences.svg/600px-Okuns_law_quarterly_differences.svg.png)
